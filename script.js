...
const toDo5 = new MultiToDo('scadenze', ToDo.TYPE.medio, ['vario'], [toDo1, toDo2, toDo3, toDo4]);
const toDo6 = new ExpiringToDo('test', ToDo.TYPE.medio, ['test'])
...
console.log(toDo6.toString())
console.log(toDo7.toString())
